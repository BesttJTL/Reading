...
// // สำคัญมากๆการเปลี่ยนค่าของ array
...
//   console.log(sum1 += data[i]) //sum1=sum1+data[i]
// }
...
// console.log(randNum)
// let useNum = Math.floor(randNum) + 1  //random 1-10 Math.ceil ปัดขึึ้น Math.floor ปัดลง 
// console.log(useNum)
// console.log('--------------')
// let random = Math.random()*((25-10)+1)+10 //(Math.random() * ((max - min) + 1)) + min
// console.log(random)
// console.log('--------------')
// // String
// let str = `Hello, World!`
...
// const [x, y, ...z] = [5, 10, 15, 20, 25,10,40]
